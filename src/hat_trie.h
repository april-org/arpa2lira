// file taken from 
// https://github.com/luikore/hat-trie/blob/master/COPYING
// seems to be from: https://github.com/luikore/hat-trie
// with license https://github.com/luikore/hat-trie/blob/master/COPYING
